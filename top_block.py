...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._xs_bw_range = Range(0, 2, 0.05, 0.5, 200)
        self._xs_bw_win = RangeWidget(self._xs_bw_range, self.set_xs_bw, "'xs_bw'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._xs_bw_win)
        ...
        self.digital_psk_mod_0 = digital.psk.psk_mod(
            ...
            verbose=False,
            log=False)
        self.digital_pfb_clock_sync_xxx_0 = digital.pfb_clock_sync_ccf(sps, loop_bw, rrc_taps, 32, 16, 1.5, 1)
        ...
        self.connect((self.blocks_throttle_0, 0), (self.qtgui_eye_sink_x_0_0, 0))
