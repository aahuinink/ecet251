...
class mpsk_stage3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_eye_sink_x_0_0.set_samp_per_symbol(4)
        ...
        self.qtgui_eye_sink_x_0_0.set_trigger_mode(qtgui.TRIG_MODE_AUTO, qtgui.TRIG_SLOPE_POS, 0.0, 0, 0, "")
        ...
        self.digital_psk_mod_0 = digital.psk.psk_mod(
            ...
            verbose=False,
            log=False)
        self.digital_pfb_clock_sync_xxx_0 = digital.pfb_clock_sync_ccf(sps*1.002, timing_loop_bw, rrc_taps, nfilts, nfilts/2, 1.5, 1)
        ...
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_cc(0.5+0.5j)
        ...
        self.connect((self.channels_channel_model_0, 0), (self.qtgui_eye_sink_x_0_0, 0))
